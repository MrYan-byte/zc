Create one horizontal animation strip for Codex pet `ronin-shade`, state `running-left`.
...
Identity: same pet in every frame: Create a Codex-style 3D chibi toy desktop pet from the reference: black messy hair with white and pink highlights, pale face, calm sleepy expression, gray and white kimono with wide sleeves, small sword prop with subtle red accent, compact full-body silhouette, refined rendered toy/plush quality like Codex hatch-pet examples.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: High quality 3D chibi toy / collectible figurine look, soft painterly lighting, transparent-ready sprite silhouette, not flat SVG, not simple line art..
